...
const handleClick = () =>{
    // Swal.fire('Redirecting to the payment Page!', 'success')

    // Swal.fire({
    //     title: 'Custom Alert',
    //     text: 'This alert has no "OK" button.',
 ...
 <button className='rightbuy_btn' onClick={handleClick}>Proceed to Buy</button>
 <div className="emi">
    EMI available
 </div>
