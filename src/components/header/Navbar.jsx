            ...
            <nav>
                ...
                <div className="right">
                    ...
                    <div className="cart_btn">
                        ...
                        <ShoppingCartIcon style={{ color: 'white' }} onClick={handleCart}/>
                        </Badge>
                        <p>Cart</p>
                    </div>
